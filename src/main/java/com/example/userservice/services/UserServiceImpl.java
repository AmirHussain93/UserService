...
//        Date date = calendar.getTime();
    ...
    public User validateToken(String tokenValue) {
        ...
        try {
            ...
            System.err.println("ExpiredJwtException Token validation failed. ExpiredJwtException: " + e.getMessage());
            return null;
        } catch (io.jsonwebtoken.JwtException e) {
            System.err.println("JwtException Token validation failed.  Invalid JWT Token: " + e.getMessage());
            return null;
        }
